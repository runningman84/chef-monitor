...
default['monitor']['sensu_plugins']['network-checks'] = '2.1.0'
...
default['monitor']['sensu_plugins']['windows'] = '2.2.1' if node['platform_family'].include?('windows')
...
default['monitor']['sensu_gem_versions']['sensu-plugins-aws'] = '10.0.0'
...
default['monitor']['sensu_gem_versions']['sensu-plugins-pagerduty'] = '3.0.0'
default['monitor']['sensu_gem_versions']['aws-sdk'] = '3.0.1'
default['monitor']['sensu_gem_versions']['sensu-transport-snssqs-ng'] = '2.1.2'
default['monitor']['sensu_gem_versions']['sensu-transport-snssqs-ng'] = '2.4.0'
