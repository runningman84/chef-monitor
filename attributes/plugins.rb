...
default['monitor']['sensu_plugins']['network-checks'] = '2.0.0'
default['monitor']['sensu_plugins']['load-checks'] = '3.0.0'
default['monitor']['sensu_plugins']['cpu-checks'] = '1.1.1'
default['monitor']['sensu_plugins']['process-checks'] = '2.0.0'
default['monitor']['sensu_plugins']['memory-checks'] = '2.1.0'
default['monitor']['sensu_plugins']['disk-checks'] = '2.1.0'
...
default['monitor']['sensu_plugins']['logs'] = '1.1.2'
